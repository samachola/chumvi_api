...
class ApiTestCase(unittest.TestCase):  
    ...
    def test_username_contains_special_character(self):
        ...
        response = self.tester.post('/api-v0/auth/register', data=json.dumps({'username': 'achola#', 'email': 'sam@example.org', 'password': 'Osupportit.0'}), content_type="application/json")
        data = json.loads(response.data)
        self.assertEqual(data['message'], 'Special characters are not allowed in username')
    ...
    def test_add_category_with_special_char(self):
        ...
        self.assertEqual(data['status'], False)
        self.assertEqual(data['message'], 'Category name and Description should not contain special characters')
    ...
    def test_add_recipe_with_special_char(self):
        ...
        print(resp['message'])
        self.assertEqual(response.status_code, 401)
        self.assertEqual('Recipe info should not contain special characters', resp['message'])
